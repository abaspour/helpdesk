...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.nicico.helpdesk.controller"))
	...
	private ApiInfo getApiInfo() {
		return new ApiInfoBuilder()
				.title("NICICO")
				.description("NICICO API for HelpDesk")
				.termsOfServiceUrl(null)
				.contact(new Contact("Admin", "https://nicico.ir", "admin@nicico.com"))
				.license(null)
				.licenseUrl(null)
				.version("1.0")
				.build();
