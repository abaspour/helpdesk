...
import com.nicico.helpdesk.iservice.IInstructionService;
...
public class InstructionRestController {
	...
	public ResponseEntity<TotalResponse<InstructionDTO.Info>> list(@RequestParam MultiValueMap<String, String> criteria) {
